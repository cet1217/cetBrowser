angular.module('cetExplorer')
	...
	var blockNum = $scope.blockNum = parseInt(web3.cet.blockNumber, 10);
	...
	for (var i = 0; i < maxBlocks; ++i) {
	    $scope.blocks.push(web3.cet.getBlock(blockNum - i));
	}
	
        $scope.processRequest = function() {
             var requestStr = $scope.cetRequest.split('0x').join('');
